---
title: Exercise Volume for Secondary Prevention
created: 2026-05-23
updated: 2026-05-23
type: concept
tags: [goal, physiology, assessment-metric]
sources: [raw/Optimizing_Exercise_Volume_for_Secondary_Prevention.md, raw/cardiac-recovery-fitness-protocol-deep-research.md]
confidence: high
---
...
Traditional thrice-weekly supervised CR sessions often fall short of the 1000 kcal/week minimum:
- Males <65 years: average **305 ± 108 kcal** per session
- Males ≥65 years: average **266 ± 100 kcal** per session
...
To achieve documented plaque regression, patients must achieve a mean volume of approximately 2200 kcal/week. This is substantially above standard CR program outputs and requires either:
- Higher exercise frequency (4–5 days/week)
- Longer session duration (45–60+ minutes)
- Incorporation of higher-intensity intervals (with appropriate risk stratification and telemetry)
- Home-based activity accumulation outside supervised sessions
