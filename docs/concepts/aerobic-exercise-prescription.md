...
updated: 2026-05-23
type: concept
tags: [assessment-metric, physiology, cardiac-phase]
sources: [raw/Exercise_Progression_and_GXT_Standards.md, raw/cardiac-recovery-fitness-protocol-deep-research.md]
confidence: high
---
...
In the absence of GXT data, initial targets must be estimated using:
- **Resting heart rate + 20–30 bpm** as a starting point
- **Borg Rating of Perceived Exertion (RPE) ceiling of 11–14** (6–20 scale, "light" to "somewhat hard")
